...
/**
 * Vacuum diagnostic severity values, mirroring the numeric enum surfaced in JSON reports.
 */
export const DiagnosticSeverity = { Error: 0, Warning: 1, Information: 2, Hint: 3 } as const;

/**
 * Shape returned by the ruleset functions under unit test (message + optional path).
 */
