declare module '../functions/legacy/is-api-info-json-schema.js' {
  export default function validateApiInfo(schema: any): { message: string }[];
}

declare module '../functions/legacy/is-problem-json-schema.js' {
  export default function validateProblemSchema(schema: any): { message: string }[];
}

declare module '../functions/legacy/is-object-schema.js' {
  export default function validateObjectSchema(schema: any): { message: string }[];
}

declare module '../functions/legacy/count-resource-types.js' {
